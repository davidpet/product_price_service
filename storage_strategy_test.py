...
from storage_strategy import UnitTestingStorageStrategy, ManualTestingStorageStrategy, MirroredDatabaseStorageStrategy, get_storage_strategy
...
class StorageStrategyTests(unittest.TestCase):
    ...
    #       should call the protected methods of your subclass in the right
    #       order
    #       try various code paths and a subclass that traces calls
    #       subclass controls the code paths via return values from the
    #       protected methods
    #       (didn't update it for now because I feel a little uneasy about
    #        how tightly coupled the tests and virtual methods will be to the
    #        specific algorithm)
